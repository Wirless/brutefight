// Skills System
// Handles player skills like mining, woodcutting, etc.
...
class SkillsManager {
    ...
    createUI() {
        ...
        this.skillsWindow.style.top = '200px'; // Positioned below other UI elements
        this.skillsWindow.style.width = '220px'; // Slightly wider for better readability
        this.skillsWindow.style.maxHeight = '400px';
        this.skillsWindow.style.backgroundColor = 'rgba(0, 0, 0, 0.85)'; // Slightly more opaque
    ...
    createToggleButton() {
        ...
        toggleButton.style.top = '170px'; // Positioned below other UI elements
